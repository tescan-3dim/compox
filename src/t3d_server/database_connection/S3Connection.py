...
from t3d_server.database_connection.database_utils import (
    S3FileUploader,
...
class S3Connection(BaseConnection):
    ...
    def get_presigned_download_url(
        self, collection_name, object_name, expiration=3600
    ) -> str:
    ...
    def generate_presigned_url(
        self, client_method, collection_name, object_name, expiration=3600
    ) -> str:
