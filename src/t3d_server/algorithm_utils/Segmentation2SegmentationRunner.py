...
from t3d_server.algorithm_utils.io_schemas import SegmentationSchema
...
class Segmentation2SegmentationRunner(BaseRunner):
    ...
    def fetch_data(self, file_ids: list[str], *keys: str) -> list[dict]:
        ...
        """
        return self.task_handler.fetch_data(file_ids, SegmentationSchema, *keys)
    ...
    def preprocess(self, input_data: dict, args: dict = {}) -> np.ndarray:
        ...
        for i in range(len(input_images)):
            input_images[i] = input_images[i]["mask"]
