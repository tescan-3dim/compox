...
if __name__ == "__main__":
    ...
    # Load the TOML file
    toml_file_path = "C:/Users/Jan Matula/Work/python-computing-backend/t3d_server/algorithms/template_segmentation_algorithm/pyproject.toml"
    ...
    algorithm_config = toml_data.get("tool", {}).get("t3dserver", {})
