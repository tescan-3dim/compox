...
from t3d_server.server_utils import generate_uuid, find_algorithm_by_id
...
def execute_algorithm(
    ...
    if settings.inference.backend_settings.executor == "celery":
        ...
        from t3d_server.tasks.fastapi_background_task import (
...
async def get_execution_record(id: str, request: Request):
    """
