...
import io
import h5py
from t3d_server.server_utils import generate_uuid, calculate_s3_etag
...
async def download_dataset(id: str, request: Request):
    """
