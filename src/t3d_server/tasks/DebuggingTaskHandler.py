...
from t3d_server.database_connection.InMemoryConnection import InMemoryConnection
import sys
import os
import io
...
class DebuggingTaskHandler(TaskHandler):
    ...
    database_connection : object
        In this case, the database connection is the path to the local filesystem.
    """
    ...
    def __init__(self, task_id: str):
        ...
        temp_folder_name : str
            The name of the temporary folder, where the files will be stored.
        """
