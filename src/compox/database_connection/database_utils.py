...
class S3FileUploader:
    ...
    """
    def __init__(self, s3_client: boto3.client, chunk_size: int =8 * 1024 * 1024, num_threads: int =8):
    ...
    def upload_part(self, part: bytes, key: str, bucket: str, part_number: int, upload_id: str) -> dict:
        """
