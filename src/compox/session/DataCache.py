...
class DataCache:
    ...
    def __init__(self, max_size: int = 5, max_memory_mb: int | None = None):
        self.cache = {}
        self.cache_keys = []
    ...
    def __getitem__(self, key: str) -> Any:
        ...
        ------
        KeyError
            If key is not found or it is removed from cache due to exceeding cache size or memory limit.
        """
