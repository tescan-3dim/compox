...
class Runner(BaseRunner):
    ...
    def load_assets(self):
        ...
        self.log_message("No assets to load for the Bar algorithm.")
    ...
    def preprocess(self, input_data: ImageSchema, args: dict = {}) -> tuple:
        ...
        self.log_message("Preprocessing the Bar input data.")
    ...
    def inference(
        ...
        self.log_message("Running the Bar inference.")
        return my_function()
    ...
    def postprocess(self, inference_output: str, args: dict = {}) -> dict:
        ...
        self.log_message("Postprocessing the Bar inference output.")
